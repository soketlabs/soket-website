        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="flex flex-col items-start lg:pl-[10%] lg:w-4/5">
            <p className="text-base mb-8 text-gray-800 text-left">
              We believe in building AI technologies that are not just powerful,
              but also responsible—prioritizing human well-being, transparency,
              and fairness in all our innovations.
            </p>
        ...
        <div className="grid md:grid-cols-3 gap-2 mt-20 lg:mt-30">
          ...
          <div className="bg-white rounded-lg p-6 lg:pt-20 shadow-sm">
            ...
            <p className="text-base text-left text-black opacity-60 font-medium">
              Fully open-source, built in public ensuring inclusivity across
          ...
          <div className="bg-white rounded-lg p-6 lg:pt-20 shadow-sm">
            ...
            <p className="text-base text-left text-black opacity-60 font-medium">
              Prioritizes energy-efficient training, high-quality data
              practices, and climate-conscious algorithms.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg p-6 lg:pt-20 shadow-sm">
            ...
            <p className="text-base text-left text-black opacity-60 font-medium">
              Empowering global intelligence through an India-first, world-ready
              foundation model.
            </p>
          </div>
        </div>
