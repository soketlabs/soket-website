...
const Footer = () => {
  const socialLinks = [
    {
      name: 'Facebook',
      href: 'https://facebook.com/soketai',
      icon: (
    ...
    {
      name: 'Instagram',
      href: 'https://instagram.com/soketai',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    {
      name: 'YouTube',
      href: 'https://youtube.com/@soketai',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    {
      name: 'LinkedIn',
      href: 'https://linkedin.com/company/soketai',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    <footer className="bg-soket-dark py-7">
      <div className="mx-5 lg:mx-[8%] flex flex-col md:flex-row justify-between items-center">
        <p className="text-white/80 text-sm lg:text-base font-geist-mono mb-4 md:mb-0 text-center lg:text-left">
          © 2024 SOKET AI LABS. ALL RIGHTS RESERVED
        </p>
